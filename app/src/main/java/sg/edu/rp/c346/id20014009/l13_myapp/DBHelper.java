...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Shoe> getAllSongs() {
        ArrayList<Shoe> songslist = new ArrayList<Shoe>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Shoe newSong = new Shoe(id, title, singers, year, stars);
    ...
    public ArrayList<Shoe> getAllSongsByStars(int starsFilter) {
        ArrayList<Shoe> songslist = new ArrayList<Shoe>();
    ...
    public int updateSong(Shoe data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
